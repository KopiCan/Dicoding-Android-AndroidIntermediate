...
import com.dicoding.andrintermediate2.database.RemoteKeys
import com.dicoding.andrintermediate2.database.StoryDatabase
import com.dicoding.andrintermediate2.response.ListStory
import com.dicoding.andrintermediate2.ui.utilitys.wrapEspressoIdling
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        wrapEspressoIdling {
            return try {
                val responseData = apiService.getStories(page, state.config.pageSize, authToken).listStory
